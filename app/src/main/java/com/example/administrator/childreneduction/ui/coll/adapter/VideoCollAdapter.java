...
public class VideoCollAdapter extends RecyclerView.Adapter<VideoCollAdapter.CViewHolder> implements View.OnClickListener {
    private Context mContext;
    private OnClickListener mOnClickListener;
    private List<UV_Table> mList;

    public VideoCollAdapter(Context mContext) {
     ...
     * @param list
     */
    public void setAddData(List<UV_Table> list) {
        mList.addAll(list);
    ...
    public void onBindViewHolder(final CViewHolder holder, int position) {
        ...
        UV_Table table = mList.get(position);
